...
def main(config_path):
    ...
    def log_audio(accelerator, audio, bib="", name="Validation", epoch=0, sr=441000, tracker="tensorboard"):
        ...
        for i, batch in enumerate(train_dataloader):
            ...
            with torch.no_grad():
                ...
                try:
                    ...
                    if accelerator.is_main_process: print(f"Text aligner failed: {e}");
                    continue
        ...
        with torch.no_grad():
            ...
            for batch_idx, batch in enumerate(val_dataloader):
                ...
                try:
                    ...
                    F0_fake, N_fake = model.predictor(texts=p_en, style=s)
        ...
        if epoch < diff_epoch:
            ...
            with torch.no_grad():
                for bib in range(len(asr)):
                    ...
                    F0_fake, N_fake = model.predictor(texts=p_en, style=s_dur)
